  ...
  return (
    <div className="relative h-[400px] overflow-hidden">
      ...
      <div className="relative h-full container mx-auto px-4 flex flex-col justify-center">
       ...
       {/* Decorative Elements */}
      <div className="absolute bottom-0 left-0 w-full h-16 bg-gradient-to-t dark:from-[#050816] from-gray-50 to-transparent" />
      <div className="absolute -bottom-px left-0 w-full h-1 dark:bg-[#050816] bg-gray-50" />
    </div>
  );
};
