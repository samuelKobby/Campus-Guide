            ...
            <Parallax translateY={[-12, 12]}>
              <section className="mb-20">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6" style={{ perspective: '1200px' }}>
                  {[
                    { img: 'https://verdipharmacy.com/wp-content/uploads/2025/06/5.jpg', label: 'Campus Pharmacy', sub: 'Legon Main Campus', rotate: 'rotateY(-8deg) rotateX(4deg)' },
              ...
              <section className="mb-20">
                ...
                >
                  ...
                  <div className="flex gap-5 mb-5 marquee-left" style={{ width: 'max-content' }}>
                    {[
                      { handle: '@AbenaK_300', img: 'https://img.magnific.com/free-photo/african-teenage-girl-portrait-happy-smiling-face_53876-146757.jpg?semt=ais_hybrid&w=740&q=80', text: "I used to walk to three pharmacies before finding my medication. Now I check Campus Guide first and go straight to the right one. Total lifesaver!" },
                      { handle: '@KofiM_Eng',  img: 'https://static.vecteezy.com/system/resources/thumbnails/050/435/189/small/a-young-man-with-glasses-and-a-backpack-photo.jpeg', text: "The navigation feature is brilliant. I'm new on campus and I found the health center on my very first try. UI is super clean." },
                      { handle: '@AmaS_Biz',   img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRMKF2Q6FueYpclojWIaMTzJnMuDm1oTzrphw&s', text: "Love that it shows opening hours and stock together. Saved me so much time during exam season when I couldn't search around." },
                      { handle: '@Kwame_Pharm',img: 'https://www.shutterstock.com/image-photo/handsome-african-male-university-student-260nw-252976372.jpg', text: "Found a pharmacy open at 10 PM in under a minute. No cap, this app is built for students who actually need things fast." },
                      { handle: '@EfiaSci',    img: 'https://thumbs.dreamstime.com/b/serious-beauty-face-black-woman-confidence-white-background-studio-closeup-student-portrait-serious-beauty-285441988.jpg', text: "The prescription upload feature blew my mind. Sent it, got confirmation of availability. Done. Didn't even have to leave my room." },
                      { handle: '@NanaB_Arts', img: 'https://img.magnific.com/premium-photo/student-university-portrait-black-man-education-learning-excited-future-career-campus-face-african-person-library-with-glasses-research-school-project-studying_590464-221802.jpg?semt=ais_hybrid&w=740&q=80', text: "Compared prices across two pharmacies, saved GH₵8. Small thing but it adds up when you're a broke student." },
                  ...
                  <div className="flex gap-5 marquee-right" style={{ width: 'max-content' }}>
                    {[
                      { handle: '@OseiMed2',   img: 'https://www.shutterstock.com/image-photo/black-student-education-man-smile-260nw-2210718553.jpg', text: "Finally an app that knows what's in stock before I even walk there. Every student clinic should have this." },
                      { handle: '@YaaLaw400',  img: 'https://www.shutterstock.com/image-photo/black-woman-portrait-smile-glasses-260nw-2256248329.jpg', text: "Shared it with my whole hall. Three people already used it during the flu wave. We all got our meds without any drama." },
                      { handle: '@Baffour_IT', img: 'https://img.freepik.com/premium-photo/portrait-smiling-african-american-student-looking-camera-sitting-cafe-black-millennial-man-posing-making-picture-coffeeshop-afro-male-glasses-drinking-coffee-working-coffeehouse_650366-8364.jpg', text: "As an IT student I respect the build quality. Fast, no bugs, does exactly what it says. Rare for a campus app." },
                      { handle: '@Akosua_Sci', img: 'https://i.pinimg.com/736x/9b/89/dc/9b89dcbf0c71fb7d7887f989a8fa389b.jpg', text: "The dark mode is everything. Using Campus Guide at night before bed to check if the pharmacy opens early — and it just works perfectly." },
                      { handle: '@DwobengK',   img: 'https://img.freepik.com/premium-photo/smile-young-afro-male-student-with-eyeglasses-university_145713-24587.jpg?w=360', text: "Directions took me straight there. No confusion, no asking around. Just opened the app and walked to the door." },
                      { handle: '@MaameE_300', img: 'https://i.pinimg.com/1200x/a5/e2/d4/a5e2d4ebd8e080b98643baad1d2b318a.jpg', text: "I didn't know half the pharmacies on campus existed until Campus Guide showed me. There's one 2 mins from my hostel!" },
                      // duplicate for seamless loop
                      { handle: '@OseiMed2',   img: 'https://www.shutterstock.com/image-photo/black-student-education-man-smile-260nw-2210718553.jpg', text: "Finally an app that knows what's in stock before I even walk there. Every student clinic should have this." },
                      { handle: '@YaaLaw400',  img: 'https://www.shutterstock.com/image-photo/black-woman-portrait-smile-glasses-260nw-2256248329.jpg', text: "Shared it with my whole hall. Three people already used it during the flu wave. We all got our meds without any drama." },
                      { handle: '@Baffour_IT', img: 'https://img.freepik.com/premium-photo/portrait-smiling-african-american-student-looking-camera-sitting-cafe-black-millennial-man-posing-making-picture-coffeeshop-afro-male-glasses-drinking-coffee-working-coffeehouse_650366-8364.jpg', text: "As an IT student I respect the build quality. Fast, no bugs, does exactly what it says. Rare for a campus app." },
