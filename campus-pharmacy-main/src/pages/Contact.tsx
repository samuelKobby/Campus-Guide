  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative min-h-[600px] overflow-hidden">
        ...
        {/* Hero Content */}
        <div className="relative h-full container mx-auto px-4 pt-32 pb-20 flex flex-col justify-center">
          <motion.div
          ...
          >
            ...
            <motion.p
              ...
              className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed mb-10"
            >
        ...
        <div className="absolute bottom-0 left-0 w-full h-20 bg-gradient-to-t from-[#F2ECFD] dark:from-[#050816] to-transparent" />
      </div>
      ...
      <div className="bg-gradient-to-b from-[#F2ECFD] to-white dark:from-[#050816] dark:to-[#0a0a2a] relative">
        ...
        {/* Main Content */}
        <section className="relative z-10 px-4 sm:px-6 lg:px-8 pb-20 pt-8">
          <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
            
            {/* Contact Form */}
            <div className="bg-white/80 dark:bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-gray-200 dark:border-white/10 shadow-2xl hover:shadow-purple-500/20 dark:hover:shadow-purple-500/10 transition-all duration-500">
            ...
            <div className="space-y-8">
              <div className="bg-white/80 dark:bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-gray-200 dark:border-white/10 shadow-2xl hover:shadow-cyan-500/20 dark:hover:shadow-cyan-500/10 transition-all duration-500">
                ...
                <div className="space-y-6">
                  <div className="group flex items-start space-x-4 p-5 border border-gray-200 dark:border-white/10 bg-white/50 dark:bg-white/5 rounded-2xl hover:bg-gradient-to-r hover:from-cyan-50 hover:to-purple-50 dark:hover:from-cyan-950/20 dark:hover:to-purple-950/20 transition-all duration-300 hover:shadow-lg">
                    <div className="p-3 bg-gradient-to-br from-cyan-500 to-purple-600 rounded-xl flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
                      <MapPin className="h-5 w-5 text-white" />
                    </div>
                    <div>
                      <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Visit Us</h3>
                      <p className="text-gray-700 dark:text-gray-300">Student Services Building<br />Room 204, Main Campus<br />University Drive, Campus City</p>
                    </div>
                  </div>
                  ...
                  <div className="group flex items-start space-x-4 p-5 border border-gray-200 dark:border-white/10 bg-white/50 dark:bg-white/5 rounded-2xl hover:bg-gradient-to-r hover:from-cyan-50 hover:to-purple-50 dark:hover:from-cyan-950/20 dark:hover:to-purple-950/20 transition-all duration-300 hover:shadow-lg">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 dark:text-gray-300">+1 (555) 123-GUIDE<br />+1 (555) 123-4843</p>
                    </div>
                  </div>
                  ...
                  <div className="group flex items-start space-x-4 p-5 border border-gray-200 dark:border-white/10 bg-white/50 dark:bg-white/5 rounded-2xl hover:bg-gradient-to-r hover:from-cyan-50 hover:to-purple-50 dark:hover:from-cyan-950/20 dark:hover:to-purple-950/20 transition-all duration-300 hover:shadow-lg">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 dark:text-gray-300">help@campusguide.edu<br />support@campusguide.edu</p>
                    </div>
                  </div>
                  ...
                  <div className="group flex items-start space-x-4 p-5 border border-gray-200 dark:border-white/10 bg-white/50 dark:bg-white/5 rounded-2xl hover:bg-gradient-to-r hover:from-cyan-50 hover:to-purple-50 dark:hover:from-cyan-950/20 dark:hover:to-purple-950/20 transition-all duration-300 hover:shadow-lg">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 dark:text-gray-300">Monday - Friday: 8:00 AM - 6:00 PM<br />Saturday: 10:00 AM - 4:00 PM<br />Sunday: Closed</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Quick Help Section */}
              <div className="bg-gradient-to-br from-cyan-500/10 to-purple-600/10 dark:from-cyan-600/20 dark:to-purple-600/20 backdrop-blur-xl rounded-3xl p-8 border border-gray-200 dark:border-white/10 hover:shadow-lg transition-all duration-500">
