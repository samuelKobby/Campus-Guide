...
export const Header: React.FC<HeaderProps> = ({ adminName, onMenuClick, isVisible = true }) => {
  ...
  return (
    <header className={`bg-white/20 backdrop-blur-md shadow-sm mt-4 mr-4 ml-4 rounded-full border border-white/30 relative z-50 transition-opacity duration-200 dark:bg-gray-800/20 dark:border-gray-700/30 ${!isVisible ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
      <div className="flex justify-between items-center px-4 sm:px-6 py-4">
        <div className="flex items-center">
          <button 
            onClick={onMenuClick}
            className="p-2 rounded-md text-gray-600 hover:text-gray-800 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-gray-500 lg:hidden dark:text-gray-300 dark:hover:text-white dark:hover:bg-gray-700"
          >
            <FaBars className="w-6 h-6" />
          </button>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-800 ml-2 sm:ml-0 dark:text-white">Admin Dashboard</h1>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative" ref={notificationsRef}>
            <button 
              className="text-gray-600 hover:text-gray-800 relative dark:text-gray-300 dark:hover:text-white"
            ...
            {showNotifications && (
              <div className="absolute right-0 mt-2 w-80 bg-white rounded-md shadow-lg py-1 z-[60] border border-gray-100 dark:bg-gray-800 dark:border-gray-700">
                <div className="px-4 py-2 border-b border-gray-100 flex justify-between items-center dark:border-gray-700">
                  ...
                  {loading ? (
                    ...
                    notifications.map((notification) => {
                      ...
                      switch (notification.type) {
                        case 'success': bgColor = 'bg-green-50 dark:bg-green-900/20'; break;
                        case 'warning': bgColor = 'bg-yellow-50 dark:bg-yellow-900/20'; break;
                        case 'error': bgColor = 'bg-red-50 dark:bg-red-900/20'; break;
                        default: bgColor = 'bg-blue-50 dark:bg-blue-900/20';
                      }
                      
                      return (
                        <div
                          key={notification.id}
                          className={`px-4 py-3 hover:bg-gray-50/80 dark:hover:bg-gray-700/80 ${bgColor} border-b border-gray-100 dark:border-gray-700 relative ${selectMode ? 'cursor-pointer' : ''}`}
                ...
                <Link
                  ...
                  className="block px-4 py-2 text-sm text-blue-600 hover:bg-gray-50/80 border-t border-gray-100 dark:text-blue-400 dark:hover:bg-gray-700/80 dark:border-gray-700"
                >
          ...
          <div className="relative" ref={profileMenuRef}>
            ...
            {/* Profile dropdown */}
            {showProfileMenu && (
              <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-[60] border border-gray-100 dark:bg-gray-800 dark:border-gray-700">
                <Link
                  to="/admin/profile"
                  className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-50/80 dark:text-gray-300 dark:hover:bg-gray-700/80"
                >
                ...
                <button
                  ...
                  className="flex items-center w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-50/80 dark:text-gray-300 dark:hover:bg-gray-700/80"
                >
