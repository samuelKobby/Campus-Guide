...
+            }`}>Admin Notes</label>
             <textarea
-              className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
...
-        <div
-          key={request.id}
-          className="bg-white/20 backdrop-blur-md rounded-lg shadow-sm p-6 border border-white/30"
-        >
...
+                  className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 transition-colors"
       ...
       {requests.length === 0 && (
-        <div className="text-center py-6 bg-white/20 backdrop-blur-md rounded-lg shadow-sm p-6 border border-white/30">
